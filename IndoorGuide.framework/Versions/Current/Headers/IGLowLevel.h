...
- (void)addBluetoothPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI timestamp:(NSUInteger)t;
...
-(void)stopStreaming;
-(void)addHeading:(CLHeading*)heading;
-(CLLocationDirection)getHeadingDirection;
-(void)addMagnetometerData:(CMMagnetometerData*)mag;
-(void)addAccelerometerData:(CMAccelerometerData*)acc;
