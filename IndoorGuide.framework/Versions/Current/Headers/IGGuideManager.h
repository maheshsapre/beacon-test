 ...
 * of or in addition to other beacons. This feature has not been through thurough 
 * testing and is set to nil by default, meaning iBeacons will not be used.
 * In order to test this, please contact support@nimbledevices.com
 */
